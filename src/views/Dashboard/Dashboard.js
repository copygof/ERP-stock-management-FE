          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-primary">
              <CardBody className="pb-0">
                ...
                <h4 className="mb-0">23,139 บาท</h4>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-info">
              <CardBody className="pb-0">
                ...
                <h4 className="mb-0">129,413 ชิ้น</h4>
                <p>จำนวนรวมที่ขายได้ทั้งหมด</p>
              </CardBody>
              <div className="chart-wrapper px-3" style={{height:'70px'}}>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-warning">
              <CardBody className="pb-0">
                ...
                <h4 className="mb-0">3,143 คน</h4>
                <p>ลูกค้าที่มีอยู่ในระบบ</p>
              </CardBody>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-danger">
              <CardBody className="pb-0">
                ...
                <h4 className="mb-0">2,812 ชิ้น</h4>
                <p>สินค้าที่มีอยู่ในคลัง</p>
              </CardBody>
              <div className="chart-wrapper px-3" style={{height:'70px'}}>
              ...
              <CardBody>
                <Row>
                  <Col xs="12" md="6" xl="4">
                    <Row>
                      <Col sm="6">
                        <div className="callout callout-info">
                          <small className="text-muted">ลูกค้าใหม่</small>
                          <br/>
                          <strong className="h4">40</strong>
                          <div className="chart-wrapper">
                      ...
                      <Col sm="6">
                        <div className="callout callout-danger">
                          <small className="text-muted">ลูกค้าเดิมที่ชื้อช้ำ</small>
                          <br/>
                          <strong className="h4">534</strong>
                          <div className="chart-wrapper">
                    ...
                    <ul className="horizontal-bars">
                      ...
                      <li className="legend">
                        ...
                        <small> ลูกค้าเดิมที่ชื้อช้ำ</small>
                      </li>
                    </ul>
                  </Col>
                  <Col xs="12" md="6" xl="4">
                    <Row>
                      <Col sm="6">
                        <div className="callout callout-warning">
                          <small className="text-muted">รวม</small>
                          <br/>
                          <strong className="h4">574</strong>
                          <div className="chart-wrapper">
                    ...
                    <ul className="horizontal-bars type-2">
                      <li>
                        ...
                        <span className="title">ผู้ชาย</span>
                        <span className="value">6%</span>
                        <div className="bars">
                          <Progress className="progress-xs" color="warning" value="6"/>
                        </div>
                      </li>
                      <li>
                        <i className="icon-user-female"></i>
                        <span className="title">ผู้หญิง</span>
                        <span className="value">94%</span>
                        <div className="bars">
                          <Progress className="progress-xs" color="warning" value="94"/>
                        </div>
                      </li>
                      <li className="divider"></li>
                      <li className="divider">ธนาคารที่เลือกชำระ</li>
                      <li>
                        <i className="icon-globe"></i>
                        <span className="title">กรุงศรี</span>
                      ...
                      <li>
                        <i className="icon-globe"></i>
                        <span className="title">ไทยพาณิชย์</span>
                        <span className="value">191,235 <span className="text-muted small">(56%)</span></span>
                        <div className="bars">
                          <Progress className="progress-xs" color="success" value="56"/>
                        </div>
                      ...
                      <li>
                        <i className="icon-globe"></i>
                        <span className="title">กสิกร</span>
                        <span className="value">191,235 <span className="text-muted small">(56%)</span></span>
                        <div className="bars">
                          <Progress className="progress-xs" color="success" value="56"/>
                        </div>
                      ...
                      <li>
                        <i className="icon-globe"></i>
                        <span className="title">กรุงเทพ</span>
                        <span className="value">191,235 <span className="text-muted small">(56%)</span></span>
                        <div className="bars">
                          <Progress className="progress-xs" color="success" value="56"/>
                        </div>
                  ...
                  <Col xs="12" xl="4">
                    <Row>
                      <Col sm="6">
                        <div className="callout">
                          <small className="text-muted">การขาย</small>
                          <br/>
                    ...
                    <ul className="icons-list">
                      <li>
                        <i className="icon-user bg-primary"></i>
                        <div className="desc">
                          <div className="title">ครีมทาผิว</div>
                          <small>Lorem ipsum dolor sit amet</small>
                        </div>
                        <div className="value">
                          <div className="small text-muted">ยอดขายต่อสัปดาฬ</div>
                          <strong>1.924</strong>
                        </div>
                      ...
                      <li>
                        <i className="icon-user bg-primary"></i>
                        <div className="desc">
                          <div className="title">ครีมกันแดด</div>
                          <small>Lorem ipsum dolor sit amet</small>
                        </div>
                        <div className="value">
                          <div className="small text-muted">ยอดขายต่อสัปดาฬ</div>
                      ...
                      <li>
                        <i className="icon-user bg-primary"></i>
                        <div className="desc">
                          <div className="title">สบู่มะขาม</div>
                          <small>Lorem ipsum dolor sit amet</small>
                        </div>
                        <div className="value">
                          <div className="small text-muted">ยอดขายต่อสัปดาฬ</div>
                ...
                <Table hover responsive className="table-outline mb-0 d-none d-sm-table">
                  ...
                  <tr>
                    ...
                    <th>ชื่อลูกค้า</th>
                    <th className="text-center">การทำรายการ</th>
                    <th>สถานะ</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div>มาริสา สุนารี</div>
                        <div className="small text-muted">
                          <span>ลูกค้าใหม่</span> | สมัครเมื่อ: 1 มกราคม 2561
                        </div>
                      </td>
                      <td className="text-center">
                        แจ้งยอดชำระ
                      ...
                      <td>
                        <div className="small text-muted">เมื่อเวลาล่าสุด</div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div>อารดา มีนา</div>
                        <div className="small text-muted">
                          <span>ลูกค้าเก่า</span> | สมัครเมื่อ: 1 มกราคม 2560
                        </div>
                      </td>
                      <td className="text-center">
                        สั่งชื่อสินค้า
