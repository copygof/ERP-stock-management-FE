...
class pending extends Component {
  ...
  renderTable(id) {
    ...
    return (
      <div>
        <InputGroup>
          <Input placeholder="ค้นหาข้อมูลลูกค้า" />
        ...
        <Table hover responsive className="table-outline mb-0 d-none d-sm-table">
          <thead className="thead-light">
            <tr>
              <th>Memmber ID</th>
              <th>ชื่อลูกค้า</th>
              <th>สมัครเมื่อวันท่ี่</th>
              <th>เบอร์โทร</th>
              <th>ดูข้อมูลลูกค้า</th>
              <th>แก้ไขข้อมูลลูกค้า</th>
              <th>ดูการทำรายการ</th>
            </tr>
          </thead>
          <tbody>
  ...
  renderBillCreate(totalPrice) {
    return (
      <div>
        <ModalHeader toggle={this.toggleModal}>เพิ่มข้อมูลลูกค้าใหม่</ModalHeader>
      <ModalBody>
        <Row>
          <Col xs="12">
          {/* <InputGroup>
          ...
          <Card body outline color="secondary">
            <Row>
              <Col xs='8'>
                <CardTitle>เลขที่สมาชิก: MB-0006</CardTitle>
              </Col>
              <Col xs='4'>
          ...
          <Col xs="12">
            <Card body outline color="secondary">
              ...
              <Form>
                <FormGroup>
                  <Label for="exampleEmail">กรอกข้อมูลรายละเอียดของการสมัครสมาชิก</Label>
                  <Input plaintext>ชื่อ-ที่อยู่</Input>
                </FormGroup>
                <FormGroup>
                  <Label for="exampleEmail">ชื่อลูกค้า</Label>
                  <Input type="email" name="email" id="exampleEmail" placeholder="ชื่อ - นามสกุล" defaultValue={!this.state.userType ? '' : 'มาริสา สุนารี'} disabled={this.state.userType === 'view'} />
                </FormGroup>
                <FormGroup>
                  <Label for="exampleEmail">อายุ</Label>
                  <Input type="text" name="email" id="exampleEmail" placeholder="อายุ"  defaultValue={!this.state.userType ? '' : '23'} disabled={this.state.userType === 'view'} />
                </FormGroup>
                <FormGroup tag="fieldset">
                  <Label for="exampleEmail">เพศ</Label>
                  <FormGroup check>
                    <Label check>
                ...
                <FormGroup>
                  ...
                  <Input type="email" name="email" id="exampleEmail" placeholder="เบอร์โทร" defaultValue={!this.state.userType ? '' : '081-2345678'} disabled={this.state.userType === 'view'} />
                </FormGroup>
                <FormGroup>
                  <Label for="exampleEmail">Facebook</Label>
                  <Input type="email" name="email" id="exampleEmail" placeholder="Facebook id" defaultValue={!this.state.userType ? '' : 'mids.mina'} disabled={this.state.userType === 'view'} />
                </FormGroup>
                <FormGroup>
                  <Label for="exampleEmail">Line</Label>
                  <Input type="email" name="email" id="exampleEmail" placeholder="Line id" defaultValue={!this.state.userType ? '' : 'mina'} disabled={this.state.userType === 'view'} />
                </FormGroup>
                <FormGroup>
                  <Label for="exampleText">ที่อยู่</Label>
                  <Input type="textarea" name="text" id="exampleText" defaultValue={!this.state.userType ? '' : '234/32 ซอยมีดี ถนนลาดพร้าว'} disabled={this.state.userType === 'view'} />
                </FormGroup>
                <FormGroup>
                  <Label for="exampleEmail">แขวง/ตำบล</Label>
                  <Input type="email" name="email" id="exampleEmail" placeholder="แขวง/ตำบล" defaultValue={!this.state.userType ? '' : 'วังทองหลาง'} disabled={this.state.userType === 'view'} />
                </FormGroup>
                <FormGroup>
                  <Label for="exampleEmail">เขต/อำเภอ</Label>
                  <Input type="email" name="email" id="exampleEmail" placeholder="เขต/อำเภอ" defaultValue={!this.state.userType ? '' : 'วังทองหลาง'} disabled={this.state.userType === 'view'} />
                </FormGroup>
                <FormGroup>
                  <Label for="exampleEmail">จังหวัด</Label>
                  <Input type="email" name="email" id="exampleEmail" placeholder="จังหวัด" defaultValue={!this.state.userType ? '' : 'กรุงเทพ'} disabled={this.state.userType === 'view'} />
                </FormGroup>
                <FormGroup>
                  <Label for="exampleEmail">รหัสไปรษณีย์</Label>
                  <Input type="email" name="email" id="exampleEmail" placeholder="รหัสไปรษณีย์" defaultValue={!this.state.userType ? '' : '10310'} disabled={this.state.userType === 'view'} />
                </FormGroup>
                <FormGroup>
                  <Label for="exampleEmail">อาชีพปัจจุบัน</Label>
                  <Input type="text" name="email" id="exampleEmail" placeholder="อาชีพปัจจุบัน" defaultValue={!this.state.userType ? '' : 'พนักงานธนาคาร'} disabled={this.state.userType === 'view'} />
                </FormGroup>
                <FormGroup row>
                  <Label for="exampleFile" sm={2}>รูปถ่าย</Label>
                  <Col sm={10}>
                ...
                <FormGroup>
                  <Label for="exampleEmail">Ref.Id</Label>
                  <Input type="text" name="text" id="exampleEmail" placeholder="รหัสบุคคลแนะนำ" defaultValue={!this.state.userType ? '' : 'ref-mb0023143434'} disabled={this.state.userType === 'view'} />
                </FormGroup>
              </Form>
  ...
  render() {
    return (
      <div className="animated fadeIn">
        <Card>
          <CardHeader>ข้อมูลรายชื่อลูกค้า</CardHeader>
          <CardBody>
